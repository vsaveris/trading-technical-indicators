...
File name: simulation_fibonacci_retracement.py
    Trading signals simulation code for the Fibonacci Retracement technical
    indicator.
"""
...
for current_date in df.index:
    # Get trading signal
    ts = FibonacciRetracement(df[df.index <= current_date]).getTiSignal()
...
print('Fibonacci Retracement trading signal simulation statistics')

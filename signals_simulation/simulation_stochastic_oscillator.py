...
File name: simulation_stochastic_oscillator.py
    Trading signals simulation code for the Stochastic Oscillator technical
    indicator.
"""
...
for current_date in df.index:
    ...
    # Get trading signal
    try:
        ts = StochasticOscillator(df[df.index <= current_date])\
            .getTiSignal()
...
print('Stochastic Oscillator trading signal simulation statistics')

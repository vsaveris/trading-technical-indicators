...
File name: simulation_ichimoku_cloud.py
    Trading signals simulation code for the Ichimoku Cloud technical
    indicator.
"""
...
for current_date in df.index:
    # Get trading signal
    ts = IchimokuCloud(df[df.index <= current_date]).getTiSignal()
...
print('Ichimoku Cloud trading signal simulation statistics')

...
File name: simulation_directional_movement_index.py
    Trading signals simulation code for the Directional Movement Index
    technical indicator.
"""
...
print('Directional Movement Index trading signal simulation statistics')

...
File name: simulation_simple_moving_average.py
    Trading signals simulation code for the Simple Moving Average technical
    indicator.
"""
...
for current_date in df.index:
    # Get trading signal
    ts = SimpleMovingAverage(df[df.index <= current_date]).getTiSignal()
...
print('Simple Moving Average trading signal simulation statistics')

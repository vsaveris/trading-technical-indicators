...
File name: simulation_standard_deviation.py
    Trading signals simulation code for the Standard Deviation technical
    indicator.
"""
...
for current_date in df.index:
    ...
    # Get trading signal
    try:
        ts = StandardDeviation(df[df.index <= current_date]).getTiSignal()
...
print('Standard Deviation trading signal simulation statistics')

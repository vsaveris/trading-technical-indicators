...
File name: simulation_relative_strength_index.py
    Trading signals simulation code for the Relative Strength Index technical
    indicator.
"""
...
for current_date in df.index:
    # Get trading signal
    ts = RelativeStrengthIndex(df[df.index <= current_date]).getTiSignal()
...
print('Relative Strength Index trading signal simulation statistics')

...
File name: simulation_average_directional_movement_index.py
    Trading signals simulation code for the Average Directional Movement Index
    technical indicator.
"""
...
for current_date in df.index:
    # Get trading signal
    ts = AverageDirectionalMovementIndex(df[df.index <= current_date])\
        .getTiSignal()
...
print('Average Directional Movement Index trading signal simulation',
      'statistics')

...
File name: simulation_moving_average_convergence_divergence.py
    Trading signals simulation code for the Moving Average Convergence
    Divergence technical indicator.
"""
...
for current_date in df.index:
    ...
    # Get trading signal
    try:
        ts = MovingAverageConvergenceDivergence(df[df.index <= current_date]) \
            .getTiSignal()
...
print('Moving Average Convergence Divergence trading signal simulation',
      'statistics')

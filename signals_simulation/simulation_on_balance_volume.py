...
File name: simulation_on_balance_volume.py
    Trading signals simulation code for the On Balance Volume technical
    indicator.
"""
...
for current_date in df.index:
    # Get trading signal
    ts = OnBalanceVolume(df[df.index <= current_date]).getTiSignal()
...
print('On Balance Volume trading signal simulation statistics')

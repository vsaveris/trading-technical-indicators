...
File name: test_indicator__price_and_volume_trend.py
    tti.indicators package, _price_and_volume_trend.py module unit tests.
"""
...
class TestPriceAndVolumeTrend(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.PriceAndVolumeTrend

...
class TestLinesGraph(unittest.TestCase):
    ...
    def test_y_label_parameter_missing(self):
        ...
        with self.assertRaises(TypeError):
            plot.linesGraph(
                data=df, title="T", lines_color=["r"], alpha_values=[0.5], areas=None, x_label="X"
            )
    ...
    def test_title_parameter_missing(self):
        ...
        with self.assertRaises(TypeError):
            plot.linesGraph(
                data=df, y_label="Y", lines_color=["r"], alpha_values=[0.5], areas=None, x_label="X"
            )
    ...
    def test_lines_color_parameter_missing(self):
        ...
        with self.assertRaises(TypeError):
            plot.linesGraph(
                data=df, y_label="Y", title="T", alpha_values=[0.5], areas=None, x_label="X"
            )
    ...
    def test_alpha_values_parameter_missing(self):
        ...
        with self.assertRaises(TypeError):
            plot.linesGraph(
                data=df, y_label="Y", title="T", lines_color=["r"], areas=None, x_label="X"
            )
    ...
    def test_areas_parameter_missing(self):
        ...
        with self.assertRaises(TypeError):
            plot.linesGraph(
                data=df, y_label="Y", title="T", lines_color=["r"], alpha_values=[0.5], x_label="X"
            )
    ...
    def test_x_label_parameter_missing(self):
        ...
        self.assertIsNotNone(
            plot.linesGraph(
                data=df, y_label="Y", title="T", lines_color=["r"], alpha_values=[0.5], areas=None
            )
        )
        plt.close("all")

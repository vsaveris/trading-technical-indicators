...
File name: test_indicator_wilders_smoothing.py
    tti.indicators package, _wilders_smoothing.py module unit tests.
"""
...
class TestWildersSmoothing(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.WildersSmoothing

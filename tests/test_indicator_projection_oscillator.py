...
File name: test_indicator_projection_oscillator.py
    tti.indicators package, _projection_oscillator.py module unit tests.
"""
...
class TestProjectionOscillator(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.ProjectionOscillator

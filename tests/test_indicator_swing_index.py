...
File name: test_indicator_swing_index.py
    tti.indicators package, _swing_index.py module unit tests.
"""
...
class TestSwingIndex(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.SwingIndex
    ...
    required_input_data_columns = ["open", "high", "low", "close"]

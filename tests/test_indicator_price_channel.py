...
File name: test_indicator_price_channel.py
    tti.indicators package, _price_channel.py module unit tests.
"""
...
class TestPriceChannel(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.PriceChannel

...
File name: test_indicator_chaikin_oscillator.py
    tti.indicators package, _chaikin_oscillator.py module unit tests.
"""
...
class TestChaikinOscillator(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.ChaikinOscillator

    ti_data_rows = [0, 89, 90]

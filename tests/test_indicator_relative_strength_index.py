...
class TestRelativeStrengthIndex(unittest.TestCase):
    ...
    def test_input_data_required_column_volume_missing(self):
        ...
        with self.assertRaises(ValueError):
            RelativeStrengthIndex(pd.DataFrame(df.drop(columns=['volume'])))
    ...
    def test_fill_missing_values_is_true(self):
        ...
        df_result = RelativeStrengthIndex(df, fill_missing_values=True)\
            ._input_data
    ...
    def test_fill_missing_values_is_false(self):
        ...
        df_result = RelativeStrengthIndex(df, fill_missing_values=False)\
            ._input_data
    ...
    def test_fill_missing_values_is_default_true(self):
        ...
        df_result = RelativeStrengthIndex(df)._input_data
    ...
    def test_validate_indicator_one_row(self):
        ...
        df_result = RelativeStrengthIndex(df[df.index == '2000-02-01'])\
            ._ti_data
    ...
    def test_validate_indicator_full_data(self):
        ...
        df_result = RelativeStrengthIndex(df)._ti_data
    ...
    def test_getTiData(self):
        ...
        pd.testing.assert_frame_equal(df_expected_result,
                                      RelativeStrengthIndex(df).getTiData())
    ...
    def test_getTiValue_specific(self):
        ...
        self.assertEqual(df_expected_result.loc['2000-04-25', 'OBV'],
                         RelativeStrengthIndex(df).getTiValue('2000-04-25'))
    ...
    def test_getTiValue_latest(self):
        ...
        self.assertEqual(df_expected_result.iloc[-1, 0],
                         RelativeStrengthIndex(df).getTiValue())

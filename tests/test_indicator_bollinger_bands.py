...
class TestBollingerBands(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.BollingerBands
    ...
    arguments_wrong_type = [
        ...
        {'input_data': df, 'std_number': 'no_numeric'},
    ...
    arguments_wrong_value = [
        ...
        {'input_data': df, 'std_number': -1},
        {'input_data': df, 'std_number': 0}
    ]

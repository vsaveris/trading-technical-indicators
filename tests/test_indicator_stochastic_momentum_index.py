...
class TestStochasticMomentumIndex(unittest.TestCase, TestIndicatorsCommon):
    ...
    indicator_input_arguments = {"period": 5, "smoothing_period": 3, "double_smoothing_period": 3}

    indicator_other_input_arguments = [
        {"period": 1, "smoothing_period": 1, "double_smoothing_period": 1},
        {"period": 1000, "smoothing_period": 100, "double_smoothing_period": 10},
        {"period": 10, "smoothing_period": 1000, "double_smoothing_period": 100},
        {"period": 100, "smoothing_period": 10, "double_smoothing_period": 1000},
        {"period": 3169, "smoothing_period": 3169, "double_smoothing_period": 3169},
    ]

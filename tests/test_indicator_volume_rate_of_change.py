...
File name: test_indicator_volume_rate_of_change.py
    tti.indicators package, _volume_rate_of_change.py module unit tests.
"""
...
class TestVolumeRateOfChange(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.VolumeRateOfChange

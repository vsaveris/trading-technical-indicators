...
File name: test_indicator_exponential_moving_average.py
    tti.indicators package, _exponential_moving_average.py module unit tests.
"""
...
class TestExponentialMovingAverage(unittest.TestCase):
    ...
    def test_input_data_wrong_type(self):
        with self.assertRaises(TypeError):
            ExponentialMovingAverage('NO_DF')
    ...
    def test_input_data_required_column_close_missing(self):
        ...
        with self.assertRaises(ValueError):
            ExponentialMovingAverage(pd.DataFrame(df.drop(columns=['close'])))
    ...
    def test_input_data_required_column_volume_missing(self):
        ...
        with self.assertRaises(ValueError):
            ExponentialMovingAverage(pd.DataFrame(df.drop(columns=['volume'])))
    ...
    def test_input_data_empty(self):
        ...
        with self.assertRaises(ValueError):
            ExponentialMovingAverage(pd.DataFrame(df[df.index >=
                                                     '2032-01-01']))
    ...
    def test_fill_missing_values_is_true(self):
        ...
        df_result = ExponentialMovingAverage(df, fill_missing_values=True)\
            ._input_data
    ...
    def test_fill_missing_values_is_false(self):
        ...
        df_result = ExponentialMovingAverage(df, fill_missing_values=False)\
            ._input_data
    ...
    def test_fill_missing_values_is_default_true(self):
        ...
        df_result = ExponentialMovingAverage(df)._input_data
    ...
    def test_validate_indicator_one_row(self):
        ...
        df_result = ExponentialMovingAverage(df[df.index == '2000-02-01'])\
            ._ti_data
    ...
    def test_validate_indicator_full_data(self):
        ...
        df_result = ExponentialMovingAverage(df)._ti_data
    ...
    def test_getTiGraph(self):
        ...
        obv = ExponentialMovingAverage(df)
    ...
    def test_getTiData(self):
        ...
        pd.testing.assert_frame_equal(df_expected_result,
                                      ExponentialMovingAverage(df).getTiData())
    ...
    def test_getTiValue_specific(self):
        ...
        self.assertEqual(df_expected_result.loc['2000-04-25', 'OBV'],
                         ExponentialMovingAverage(df).getTiValue('2000-04-25'))
    ...
    def test_getTiValue_latest(self):
        ...
        self.assertEqual(df_expected_result.iloc[-1, 0],
                         ExponentialMovingAverage(df).getTiValue())

    def test_getTiSignal(self):
        df = pd.read_csv('./data/sample_data.csv', parse_dates=True,
                         index_col=0)

        self.assertIn(ExponentialMovingAverage(df).getTiSignal(),
                      [('buy', -1), ('hold', 0), ('sell', 1)])

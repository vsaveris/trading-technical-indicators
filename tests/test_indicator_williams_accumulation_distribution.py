...
File name: test_indicator_williams_accumulation_distribution.py
    tti.indicators package, _williams_accumulation_distribution.py module unit
    tests.
"""
...
class TestWilliamsAccumulationDistribution(unittest.TestCase, TestIndicatorsCommon):

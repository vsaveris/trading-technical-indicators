...
File name: test_indicator_projection_bands.py
    tti.indicators package, _projection_bands.py module unit tests.
"""
...
class TestProjectionBands(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.ProjectionBands

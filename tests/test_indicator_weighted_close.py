...
File name: test_indicator_weighted_close.py
    tti.indicators package, _weighted_close.py module unit tests.
"""
...
class TestWeightedClose(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.WeightedClose

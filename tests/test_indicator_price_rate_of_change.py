...
File name: test_indicator_price_rate_of_change.py
    tti.indicators package, _price_rate_of_change.py module unit tests.
"""
...
class TestPriceRateOfChange(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.PriceRateOfChange

    ti_data_rows = [0, 2, 3]

    df = pd.read_csv('./data/sample_data.csv', parse_dates=True, index_col=0)

    indicator_input_arguments = {'period': 25}

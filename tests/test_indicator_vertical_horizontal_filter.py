...
File name: test_indicator_vertical_horizontal_filter.py
    tti.indicators package, _vertical_horizontal_filter.py module unit tests.
"""
...
class TestVerticalHorizontalFilter(unittest.TestCase, TestIndicatorsCommon):

    indicator = tti.indicators.VerticalHorizontalFilter

...
File name: test_indicator_triple_exponential_moving_average.py
    tti.indicators package, _triple_exponential_moving_average.py module unit
    tests.
"""
...
class TestTripleExponentialMovingAverage(unittest.TestCase, TestIndicatorsCommon):

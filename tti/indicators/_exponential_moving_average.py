...
File name: _exponential_moving_average.py
    Implements the Exponential Moving Average technical indicator.
"""
...
class ExponentialMovingAverage(TechnicalIndicator):
    """
    Exponential Moving Average Technical Indicator class implementation.

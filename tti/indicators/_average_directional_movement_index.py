...
File name: _average_directional_movement_index.py
    Implements the Average Directional Movement Index technical indicator.
"""
...
class AverageDirectionalMovementIndex(TechnicalIndicator):
    """
    Average Directional Movement Index Technical Indicator class
    implementation.

...
File name: _simple_moving_average.py
    Implements the Simple Moving Average technical indicator.
"""
...
class SimpleMovingAverage(TechnicalIndicator):
    """
    Simple Moving Average Technical Indicator class implementation.

...
if __name__ == "__main__":
    ...
    print("\nIndicator created in :", round(time.time() - start_time, 2), "seconds.")
    ...
    print(
        "\nTechnical Indicator value at random date:",
        ti.getTiValue(ti.getTiData().index[random.randint(0, len(ti.getTiData().index) - 1)]),
    )

    # Get the most recent indicator's value
    print("\nTechnical Indicator value at", ti.getTiData().index[-1], ":", ti.getTiValue())

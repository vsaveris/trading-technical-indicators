...
File name: example_directional_movement_index.py
    Example code for the Directional Movement Index technical indicator.
"""
...
ti = DirectionalMovementIndex(df[df.index >= '2012-01-01'])

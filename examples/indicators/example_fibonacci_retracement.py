...
File name: example_fibonacci_retracement.py
    Example code for the Fibonacci Retracement technical indicator.
"""
...
ti = FibonacciRetracement(df[df.index >= '2012-01-01'])

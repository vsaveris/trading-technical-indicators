...
File name: example_average_directional_movement_index.py
    Example code for the Average Directional Movement Index technical
    indicator.
"""
...
ti = AverageDirectionalMovementIndex(df[df.index >= '2012-01-01'])
